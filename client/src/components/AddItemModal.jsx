...
const Modal = ({ isOpen, onClose }) => {
  ...
  const handleInputChange = (e) => {
    ...
    // Convert quantity and price to numbers using Number() constructor
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios
        .post('http://localhost:5000/api/product/addProduct', itemData)
        .then((result) => {
          console.log(result);
    ...
    >
      <div className="bg-white border-4 rounded-lg shadow-lg relative w-full max-w-xl m-6 sm:w-auto">
        <div className="flex items-start justify-between p-5 border-b rounded-t">
          <h3 className="text-xl text-black font-semibold">Add product</h3>
          <button
            onClick={onClose}
            type="button"
