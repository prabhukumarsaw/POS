...
const Card = ({item}) => {
  ...
  return (
    ...
    <div key={item._id} className="max-w-2xl mx-4 sm:max-w-sm md:max-w-sm lg:max-w-sm xl:max-w-sm sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto mt-4 shadow-xl rounded-lg text-white-900"  style={{background:'#353D48'}}>
      ...
      <div className="p-3 flex items-center justify-between "  >
        <div className="flex items-center">
          <div className="ml-2 flex flex-col">
            ...
            <div className="leading-snug text-xs text-gray-400 pr-1">{item.name}</div>
          </div>
        </div>
